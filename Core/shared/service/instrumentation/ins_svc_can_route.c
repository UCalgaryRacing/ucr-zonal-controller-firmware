...
// received by rear controller for DRS
static void ins_svc_can_rx_front_wheel_speed_data(can_msg_t *msg)
{
    ...
    ins_data_set_wheel_speed_rpm(FL_WHEEL_SPEED, front_wheel_speed_can_msg.front_left_wheel_rpm);
    ins_data_set_wheel_speed_rpm(FR_WHEEL_SPEED, front_wheel_speed_can_msg.front_right_wheel_rpm);

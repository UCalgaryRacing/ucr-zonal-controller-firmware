...
#include "task_slow.h"
#include "task_can_classic_tx.h"
#include "task_can_classic_rx.h"
...
/* Definitions for CanClassicTx */
osThreadId_t CanClassicTxHandle;
const osThreadAttr_t CanClassicTx_attributes = {
  .name = "CanClassicTx",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for CanClassicRx */
osThreadId_t CanClassicRxHandle;
const osThreadAttr_t CanClassicRx_attributes = {
  .name = "CanClassicRx",
  .stack_size = 512 * 4,
...
/* Definitions for VeryFastTask */
osThreadId_t VeryFastTaskHandle;
const osThreadAttr_t VeryFastTask_attributes = {
  .name = "VeryFastTask",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityBelowNormal,
};
...
void StartCanClassicTx(void *argument);
void StartCanClassicRx(void *argument);
void StartManagerTask(void *argument);
void StartVeryFastTask(void *argument);
...
int main(void)
{
  ...
  // Ensure PA0_C is connected to the digital PA0 path for TIM2 capture.
  ...
  /* creation of CanClassicTx */
  CanClassicTxHandle = osThreadNew(StartCanClassicTx, NULL, &CanClassicTx_attributes);

  /* creation of CanClassicRx */
  CanClassicRxHandle = osThreadNew(StartCanClassicRx, NULL, &CanClassicRx_attributes);

  /* creation of ManagerTask */
  ManagerTaskHandle = osThreadNew(StartManagerTask, NULL, &ManagerTask_attributes);

  /* creation of VeryFastTask */
  VeryFastTaskHandle = osThreadNew(StartVeryFastTask, NULL, &VeryFastTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOI, GPIO_PIN_6|GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_1
                          |GPIO_PIN_3|GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_7|GPIO_PIN_5
                          |GPIO_PIN_6|GPIO_PIN_4, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_14|GPIO_PIN_11, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_4|GPIO_PIN_3, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, GPIO_PIN_7|GPIO_PIN_8|GPIO_PIN_10|GPIO_PIN_11, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, GPIO_PIN_14|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_8
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOJ, GPIO_PIN_12|GPIO_PIN_8|GPIO_PIN_1, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|GPIO_PIN_1, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_6|GPIO_PIN_10|GPIO_PIN_11, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOJ, GPIO_PIN_13|GPIO_PIN_3, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_1
                          |GPIO_PIN_7|GPIO_PIN_3|GPIO_PIN_8|GPIO_PIN_10
  ...
  /*Configure GPIO pins : PG10 PG12 PG7 PG5
                           PG6 PG4 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_7|GPIO_PIN_5
  ...
  /*Configure GPIO pins : PD5 PD4 PD3 PD1
                           PD14 PD11 */
  GPIO_InitStruct.Pin = GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_3|GPIO_PIN_1
  ...
  /*Configure GPIO pins : PH14 PH10 PH11 PH8
                           PH7 */
  GPIO_InitStruct.Pin = GPIO_PIN_14|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_8
                          |GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PE2 PE6 PE10 PE11 */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_6|GPIO_PIN_10|GPIO_PIN_11;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : PB9 PB10 PB11 PB12 */
  ...
  /*Configure GPIO pins : PJ12 PJ13 PJ8 PJ1
                           PJ3 */
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_8|GPIO_PIN_1
                          |GPIO_PIN_3;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* USER CODE BEGIN Header_StartCanClassicTx */
/**
* @brief Function implementing the CanClassicTx thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartCanClassicTx */
void StartCanClassicTx(void *argument)
{
  /* USER CODE BEGIN StartCanClassicTx */
  task_can_classic_tx_init();
  /* Infinite loop */
  for(;;)
  {
    task_can_classic_tx_loop();
  }
  /* USER CODE END StartCanClassicTx */
}

/* USER CODE BEGIN Header_StartCanClassicRx */
/**
* @brief Function implementing the CanClassicRx thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartCanClassicRx */
void StartCanClassicRx(void *argument)
{
  /* USER CODE BEGIN StartCanClassicRx */
  task_can_classic_rx_init();
  /* Infinite loop */
  for(;;)
  {
    task_can_classic_rx_loop();
  }
  /* USER CODE END StartCanClassicRx */
}
...
/* USER CODE BEGIN Header_StartVeryFastTask */
/**
* @brief Function implementing the VeryFastTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartVeryFastTask */
void StartVeryFastTask(void *argument)
{
  /* USER CODE BEGIN StartVeryFastTask */
  task_very_fast_init();
  /* Infinite loop */
  for(;;)
  {
  ...
  /* USER CODE END StartVeryFastTask */
}

...
/*============================================================================*/
/* Rear Left Suspension Configuration                                        */
/*============================================================================*/

#define INS_RL_SUSP_VOLTAGE_MIN_V             0.0f    // TODO: find real values of active and minmax voltage
#define INS_RL_SUSP_VOLTAGE_MAX_V             12.0f

#define INS_RL_SUSP_ACTIVE_MIN_V              0.0f
#define INS_RL_SUSP_ACTIVE_MAX_V              12.0f

#define INS_RL_SUSP_SCALING_FACTOR            4.85 // from resistor divider (input filter)

#define INS_RL_SUSP_POSITIVE_SLOPE            true

/*============================================================================*/
/* Rear Right Suspension Configuration                                        */
/*============================================================================*/

#define INS_RR_SUSP_VOLTAGE_MIN_V             0.0f    // TODO: find real values of active and minmax voltage
#define INS_RR_SUSP_VOLTAGE_MAX_V             12.0f

#define INS_RR_SUSP_ACTIVE_MIN_V              0.0f
#define INS_RR_SUSP_ACTIVE_MAX_V              12.0f

#define INS_RR_SUSP_SCALING_FACTOR            4.85 // from resistor divider (input filter)

#define INS_RR_SUSP_POSITIVE_SLOPE            true

/*============================================================================*/
/* ADS124S08 Instrumentation Board Config                                     */
/*============================================================================*/
...
/*============================================================================*/
/* ADS124S08 Channel Hardware Mapping                                         */
/*============================================================================*/

...
#define TRACTIVE_PUMP_2     VBATT_SW_4
#define TRACTIVE_FAN_1      VBATT_SW_5
#define ACCUMULATOR_FAN_2   VBATT_SW_6
#define ACCUMULATOR_FAN_1   VBATT_SW_7
#define TRACTIVE_FAN_2      VBATT_SW_8
#define ACULV				VBATT_SW_9
#define GOPRO               VBATT_SW_10
#define BRAKE_LIGHT         VBATT_SW_13
...
#define IMD                 VBATT_REG_SW_4 
 ...
 typedef struct {
  ...
  /*============================================================================*/
 /* INA229 struct type and initialization                                      */
 /*============================================================================*/
